...
[![GitHub Actions status](https://github.com/johnnidi/helm-push/workflows/build/badge.svg)](https://github.com/johnnidi/helm-push/actions?query=workflow%3Abuild)
...
```
$ helm plugin install https://github.com/johnnidi/helm-push
Downloading and installing helm-push v0.10.1 ...
https://github.com/johnnidi/helm-push/releases/download/v0.10.1/helm-push_0.10.1_darwin_amd64.tar.gz
